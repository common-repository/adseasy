...
Small changes to the framework; Better performance of the Google AdSense Tags
...
Framework updated; widget options refined
...
description of the button in the editor fixed; WP 4.5 ready